<template>
  <div class="reason-view">
    <el-scrollbar height="100%">
      <section class="chart">
        <echart ref="echartRef" style="height: 100%" :option="option" />
      </section>
      <section class="table">
...
import Echart from "@/component/elComponent/Echart.vue";
import { ReasonRequest } from "@/api/iot";
import { ItemType } from "./equipment.vue";
...
export default defineComponent({
  ...
  setup(props) {
    ...
    onMounted(() => {
      echartRef.value?.handleResize();
    });

    return { echartRef, tableData, option };
  },
});
</script>
