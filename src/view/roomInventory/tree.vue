  ...
  <div class="tree-wrap">
    ...
    >
      <template #default="{ node, data }">
        <span
          :style="{
            color: [1, '1'].includes(data.isBindZct) ? 'black' : '#a39f9f',
          }"
          >{{ node.label }}</span
        >
      </template>
    ...
    return {
      ...
      tmpData: [
        ...
        },
        {
          ...
          number: "DXC1",
          location:
            "project_root/ca9a81554a9f4afd97510b44a16f81f4/584320378e944af5aea90fe96cbced69",
          spaceType: 4,
        },
        {
          ...
          number: "DXC1101",
          location:
            "project_root/ca9a81554a9f4afd97510b44a16f81f4/584320378e944af5aea90fe96cbced69/5f8106d697eb401aa20964d299baca24",
          spaceType: 5,
        },
        {
