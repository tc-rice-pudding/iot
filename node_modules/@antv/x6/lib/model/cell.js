...
var Cell = /** @class */ (function (_super) {
    ...
    Cell.prototype.getChildren = function () {
        ...
        return children ? __spreadArray([], children) : null;
    };
    ...
    // #endregion
    // #region tools
    Cell.prototype.addTools = function (items, name, options) {
        if (options === void 0) { options = {}; }
        var toolItems = Array.isArray(items) ? items : [items];
        if (options.reset) {
            this.setTools({ name: name, items: toolItems }, options);
        }
        else {
            ...
            if (tools == null || name == null || tools.name === name) {
                ...
                return this.setTools(__assign({}, tools), options);
            }
        }
    };
