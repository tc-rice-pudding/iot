...
var Selection = /** @class */ (function (_super) {
    ...
    Selection.prototype.getSelectionOffset = function (client, data) {
        ...
        if (restrict) {
            ...
            var totalBBox = cell_1.Cell.getCellsBBox(cells);
    ...
    Selection.prototype.translateSelectedNodes = function (dx, dy, exclude, otherOptions) {
        ...
        this.collection.toArray().forEach(function (cell) {
            if (!map[cell.id] && cell !== exclude) {
                var options_1 = __assign(__assign({}, otherOptions), { selection: _this.cid });
    ...
    Selection.prototype.stopRotate = function (_a) {
        ...
        if (data.rotated) {
            data.rotated = false;
            this.collection.toArray().forEach(function (node) {
                util_2.notify('node:rotated', e, _this.graph.findViewByCell(node));
            });
        }
    };
    ...
    Selection.prototype.stopResize = function (_a) {
        ...
        if (data.resized) {
            data.resized = false;
            this.collection.toArray().forEach(function (node) {
                util_2.notify('node:resized', e, _this.graph.findViewByCell(node));
            });
        }
    };
    // #endregion
