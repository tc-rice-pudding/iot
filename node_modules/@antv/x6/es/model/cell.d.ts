...
export declare class Cell<Properties extends Cell.Properties = Cell.Properties> extends Basecoat<Cell.EventArgs> {
    ...
    get parent(): Cell<Cell.Properties> | null;
    get children(): Cell<Cell.Properties>[] | null;
    getParent(): Cell<Cell.Properties> | null;
    ...
    addTools(items: Cell.ToolItem | Cell.ToolItem[], name?: string | null, options?: Cell.AddToolOptions): this | undefined;
