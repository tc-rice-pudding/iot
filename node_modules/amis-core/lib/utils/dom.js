...
function calculatePosition(placement, overlayNode, target, container, padding, customOffset) {
    ...
    if (~placement.indexOf('-')) {
        ...
        while (tests.length) {
            ...
            var _b = tslib.__read(current.split('-'), 4), atX = _b[0], atY = _b[1], myX = _b[2], myY = _b[3];
            myX = myX || atX;
            myY = myY || atY;
            positionLeft =
                atX === 'left'
    ...
    var _c = tslib.__read(customOffset, 2), _d = _c[0], offSetX = _d === void 0 ? 0 : _d, _e = _c[1], offSetY = _e === void 0 ? 0 : _e;
    return {
