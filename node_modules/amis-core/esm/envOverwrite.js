...
var envOverwrite = function (schema, locale) {
    ...
    if (locale) {
        ...
        try {
            for (var schemaNodes_1 = __values(schemaNodes), schemaNodes_1_1 = schemaNodes_1.next(); !schemaNodes_1_1.done; schemaNodes_1_1 = schemaNodes_1.next()) {
    ...
    if (isMobile) {
        ...
        try {
            for (var schemaNodes_2 = __values(schemaNodes), schemaNodes_2_1 = schemaNodes_2.next(); !schemaNodes_2_1.done; schemaNodes_2_1 = schemaNodes_2.next()) {
