...
var Service = /** @class */ (function (_super) {
                ...
                return tslib.__generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            action.reload &&
                                this.reloadTarget(amisCore.filter(action.reload, store.data), store.data);
                            return [2 /*return*/];
                    }
                });
            }); })
    ...
    Service.prototype.render = function () {
        var _a = this.props, className = _a.className, style = _a.style, store = _a.store, render = _a.render, ns = _a.classPrefix, cx = _a.classnames, loadingConfig = _a.loadingConfig, showErrorMsg = _a.showErrorMsg;
        return (React__default["default"].createElement("div", { className: cx("".concat(ns, "Service"), className), style: style },
            store.error && showErrorMsg !== false ? (React__default["default"].createElement(amisUi.Alert2, { level: "danger", showCloseButton: true, onClose: function () { return store.updateMessage(''); } }, store.msg)) : null,
            this.renderBody(),
