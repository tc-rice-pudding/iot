...
var CardRenderer = /** @class */ (function (_super) {
    ...
    CardRenderer.prototype.renderToolbar = function () {
        ...
        if (selectable && !hideCheckToggler) {
            toolbars.push(React__default["default"].createElement(amisUi.Checkbox, { key: "check", className: cx('Card-checkbox'), type: multiple !== false ? 'checkbox' : 'radio', disabled: !checkable, checked: selected, onChange: this.handleCheck }));
        }
