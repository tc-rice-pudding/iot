...
var Table2 = /** @class */ (function (_super) {
    ...
    Table2.prototype.renderCellSchema = function (schema, props) {
        ...
        if (schema && amisCore.isObject(schema)) {
            ...
            return render('cell-field', tslib.__assign(tslib.__assign({}, rest), { title: title, type: 'cell-field', column: rest, data: props.data, name: schema.name }), props);
        }
        return schema;
    };
    ...
    Table2.prototype.handleSave = function (rows, diff, indexes, unModifiedItems, rowsOrigin, options) {
        ...
        if (Array.isArray(rows)) {
            ...
            store
                ...
                .then(function () {
                reload && _this.reloadTarget(amisCore.filter(reload, data_1), data_1);
            })
                .catch(function () { });
        }
        else {
            ...
            store
                ...
                .then(function () {
                reload && _this.reloadTarget(amisCore.filter(reload, data_2), data_2);
            })
                .catch(function () {
    ...
    Table2.prototype.renderActions = function (region) {
        var _this = this;
        var _a = this.props, actions = _a.actions, render = _a.render, store = _a.store, cx = _a.classnames, data = _a.data, columnsTogglable = _a.columnsTogglable; _a.$path;
