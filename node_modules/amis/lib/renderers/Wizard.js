...
var Wizard = /** @class */ (function (_super) {
    ...
    Wizard.prototype.handleAction = function (e, action, data, throwErrors, delegate) {
        ...
        if (action.actionType === 'next' ||
            ...
            action.target && this.reloadTarget(amisCore.filter(action.target, data), data);
        }
            ...
            return tslib.__generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        // 最后一步
                        if (target) {
                            this.submitToTarget(amisCore.filter(target, store.data), store.data);
                                    ...
                                    switch (_a.label) {
                                        ...
                                        case 2:
                                            ...
                                            if (finalRedirect) {
                                                ...
                                                this.reloadTarget(amisCore.filter(action.reload || step.reload || reload, store.data), store.data);
                                            }
                                            return [2 /*return*/, value];
                                    }
                                });
