...
function StepsCmpt(props) {
    var _a;
    var className = props.className, style = props.style, steps = props.steps, status = props.status, mode = props.mode, labelPlacement = props.labelPlacement, progressDot = props.progressDot, data = props.data, source = props.source, render = props.render, useMobileUI = props.useMobileUI;
...
var StepsWithRemoteConfig = amisUi.withRemoteConfig()(/** @class */ (function (_super) {
    ...
    class_1.prototype.render = function () {
        ...
        return React__default["default"].createElement(StepsCmpt, tslib.__assign({}, rest, sourceConfig));
    };
    return class_1;
