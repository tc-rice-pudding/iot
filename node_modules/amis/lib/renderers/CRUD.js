...
var CRUD = /** @class */ (function (_super) {
                ...
                return tslib.__generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            redirect && !action.blank && env.jumpTo(redirect, action);
                            action.reload
                                ? this.reloadTarget(amisCore.filter(action.reload, data), data)
                                : redirect
                                    ? null
    ...
    CRUD.prototype.handleDialogConfirm = function (values, action, ctx, components) {
        ...
        if (reload) {
            this.reloadTarget(amisCore.filter(reload, ctx), ctx);
        }
    ...
    CRUD.prototype.handleSave = function (rows, diff, indexes, unModifiedItems, rowsOrigin, options) {
        ...
        if (Array.isArray(rows)) {
            ...
            store
                ...
                finalReload
                    ? _this.reloadTarget(amisCore.filter(finalReload, data_1), data_1)
            ...
            store
                ...
                var finalReload = (_a = options === null || options === void 0 ? void 0 : options.reload) !== null && _a !== void 0 ? _a : reload;
                finalReload
                    ? _this.reloadTarget(amisCore.filter(finalReload, data_2), data_2)
                    : _this.search(undefined, undefined, true, true);
            })
                .catch(function () {
    ...
    CRUD.prototype.handleSaveOrder = function (moved, rows) {
        ...
        amisCore.isEffectiveApi(saveOrderApi, model) &&
            store
                ...
                .then(function () {
                reload && _this.reloadTarget(amisCore.filter(reload, model), model);
                _this.search(undefined, undefined, true, true);
            })
                .catch(function () { });
    };
    ...
    CRUD.prototype.renderFilterToggler = function () {
        ...
        return (React__default["default"].createElement("button", { onClick: function () { return store.setFilterVisible(!store.filterVisible); }, className: cx('Button Button--size-default Button--default', {
