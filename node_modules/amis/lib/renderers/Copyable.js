                ...
                if (copyable && !noHoc) {
                    ...
                    if (content) {
                        return (React__default["default"].createElement(Component, tslib.__assign({}, this.props, { className: cx("Field--copyable", className) }),
                            React__default["default"].createElement(Component, tslib.__assign({}, this.props, { contentsOnly: true, noHoc: true })),
                            React__default["default"].createElement(amisUi.TooltipWrapper, { placement: "right", tooltip: tooltip !== null && tooltip !== void 0 ? tooltip : __('Copyable.tip'), trigger: "hover", container: tooltipContainer || (env === null || env === void 0 ? void 0 : env.getModalContainer) },
                                React__default["default"].createElement("a", { key: "edit-btn", className: cx('Field-copyBtn'), onClick: this.handleClick.bind(this, content) },
