...
export default class CRUD extends React.Component<CRUDProps, any> {
    ...
    renderToolbar(toolbar?: SchemaNode, index?: number, childProps?: any, toolbarRenderer?: (toolbar: SchemaNode, index: number) => React.ReactNode): string | number | boolean | React.ReactFragment | JSX.Element | null;
    ...
    renderFooterToolbar(childProps: any, toolbarRenderer?: (toolbar: SchemaNode, index: number) => React.ReactNode): string | number | boolean | React.ReactFragment | JSX.Element | null;
