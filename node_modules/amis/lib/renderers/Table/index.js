...
var Table = /** @class */ (function (_super) {
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        selectedItems = value
                            ? tslib.__spreadArray(tslib.__spreadArray([], tslib.__read(store.selectedRows.map(function (row) { return row.data; })), false), [item.data], false) : store.selectedRows.filter(function (row) { return row.id !== item.id; });
                        unSelectedItems = value
                            ? store.unSelectedRows.filter(function (row) { return row.id !== item.id; })
                            : tslib.__spreadArray(tslib.__spreadArray([], tslib.__read(store.unSelectedRows.map(function (row) { return row.data; })), false), [item.data], false);
    ...
    Table.prototype.handleOutterScroll = function () {
        ...
        var theadHeight = (_b = (_a = outter
            .querySelector('thead>tr')) === null || _a === void 0 ? void 0 : _a.getBoundingClientRect()) === null || _b === void 0 ? void 0 : _b.height;
        if (scrollLeft !== this.lastScrollLeft) {
            ...
            if (fixedLeft && fixedLeft.length) {
                for (var i = 0, len = fixedLeft.length; i < len; i++) {
                    ...
                    // 同步thead高度
                    forEach__default["default"](node.querySelectorAll('thead>tr>th'), function (item) {
                        if (theadHeight) {
                            item.style.height = "".concat(theadHeight, "px");
                        }
                    });
    ...
    Table.prototype.renderCell = function (region, column, item, props, ignoreDrag) {
        ...
        var subProps = tslib.__assign(tslib.__assign({}, props), { 
            ...
            loading: column.type === 'operation' ? false : props.loading, btnDisabled: store.dragging, data: item.locals, value: column.name
                ...
                : column.value, popOverContainer: popOverContainer || this.getPopOverContainer, rowSpan: item.rowSpans[column.name], quickEditFormRef: this.subFormRef, cellPrefix: prefix, onImageEnlarge: this.handleImageEnlarge, canAccessSuperData: canAccessSuperData, row: item, itemBadge: itemBadge, showBadge: !props.isHead &&
                itemBadge &&
        ...
        return (React__default["default"].createElement("table", { className: cx('Table-table', tableClassName, {
            ...
            headerOnly ? null : !rows.length ? (React__default["default"].createElement("tbody", null,
                React__default["default"].createElement("tr", { className: cx('Table-placeholder') },
                    React__default["default"].createElement("td", { colSpan: columns.length })))) : (React__default["default"].createElement(TableBody.TableBody, { tableClassName: cx(tableClassName, {
                    'Table-table--withCombine': store.combineNum > 0
