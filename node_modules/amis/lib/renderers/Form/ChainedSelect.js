                    ...
                    switch (_d.label) {
                        ...
                        case 2:
                            stack.push({
                                ...
                                parentId: parentId,
                                loading: false,
                                visible: Array.isArray(options) && !lodash.isEmpty(options)
                            });
                            this.setState({
                                stack: stack
                            }, this.loadMore);
    ...
    ChainedSelectControl.prototype.render = function () {
        ...
        return (React__default["default"].createElement("div", { className: cx__default["default"]("".concat(ns, "ChainedSelectControl"), className) },
            ...
            this.state.stack.map(function (_a, index) {
                ...
                return visible === false || loading ? null : (React__default["default"].createElement(amisUi.Select, tslib.__assign({}, rest, { useMobileUI: useMobileUI, popOverContainer: mobileUI && env && env.getModalContainer
                        ? env.getModalContainer
                        : rest.popOverContainer, classPrefix: ns, key: "x-".concat(index + 1), options: Array.isArray(options) ? options : [], value: arr[index + 1], onChange: _this.handleChange.bind(_this, index + 1), inline: true })));
            }),
            hasStackLoading && (React__default["default"].createElement(amisUi.Spinner, { size: "sm", className: cx__default["default"]("".concat(ns, "ChainedSelectControl-spinner")) }))));
    };
