...
export declare class ControlGroupRenderer extends React.Component<InputGroupProps> {
    ...
    renderVertical(props?: Readonly<InputGroupProps>): JSX.Element | null;
    renderHorizontal(props?: Readonly<InputGroupProps>): JSX.Element | null;
    renderInput(props?: Readonly<InputGroupProps>): JSX.Element | null;
