...
var InputGroup = /** @class */ (function (_super) {
    ...
    InputGroup.prototype.render = function () {
        var _this = this;
        var _a = this.props, body = _a.body, controls = _a.controls, className = _a.className; _a.style; _a.mode; var horizontal = _a.horizontal; _a.formMode; var formHorizontal = _a.formHorizontal, data = _a.data, cx = _a.classnames, isStatic = _a.static, disabled = _a.disabled;
        ...
        var horizontalDeeper = horizontal ||
            (formHorizontal
                ...
                : undefined);
        return (React__default["default"].createElement("div", { className: cx("InputGroup", "InputGroup-validation--".concat(errorMode), className, {
