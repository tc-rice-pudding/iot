...
var TreeControl = /** @class */ (function (_super) {
    ...
    function TreeControl(props) {
        ...
        _this.handleSearch = debouce__default["default"](_this.handleSearch.bind(_this), 250, {
            trailing: true,
            leading: false
        });
        return _this;
    ...
    TreeControl.prototype.handleSearch = function (keyword) {
        ...
        var filterOptions = this.filterOptions(options, keyword);
        this.setState({
            keyword: keyword,
