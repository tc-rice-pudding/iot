...
var FormTable = /** @class */ (function (_super) {
    ...
    FormTable.prototype.componentDidUpdate = function (nextProps) {
        ...
        // 则删掉正在新增 或 编辑的那一行
        if (props.$schema.disabled !== nextProps.$schema.disabled
    ...
    FormTable.prototype.confirmEdit = function () {
        var _a, _b;
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _c, addApi, updateApi, data, env, __, subForms, validateForms, results, items, item, isNew, remote, apiMsg;
            var _this = this;
            return tslib.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        remote = null;
                        apiMsg = undefined;
                        if (!(isNew && amisCore.isEffectiveApi(addApi, amisCore.createObject(data, item)))) return [3 /*break*/, 3];
                    ...
                    case 2:
                        ...
                        return [3 /*break*/, 5];
                    case 3:
                        if (!amisCore.isEffectiveApi(updateApi, amisCore.createObject(data, item))) return [3 /*break*/, 5];
    ...
    FormTable.prototype.buildColumns = function (props, isCreateMode) {
            ...
            btns.push({
                children: function (_a) {
                    ...
                    return (~_this.state.editIndex && needConfirm !== false) ||
                        maxLength <= _this.state.items.length ? null : (React__default["default"].createElement(amisUi.Button, { classPrefix: ns, size: "sm", key: key, level: "link", tooltip: __('Table.addRow'), tooltipContainer: env && env.getModalContainer ? env.getModalContainer : undefined, disabled: disabled, onClick: _this.addItem.bind(_this, rowIndex + offset, undefined) },
        ...
        if (!isStatic && props.copyable && props.showCopyBtn !== false) {
            btns.push({
                children: function (_a) {
                    var key = _a.key, rowIndex = _a.rowIndex, offset = _a.offset;
                    return ~_this.state.editIndex && needConfirm !== false ? null : (React__default["default"].createElement(amisUi.Button, { classPrefix: ns, size: "sm", key: key, level: "link", tooltip: __('Table.copyRow'), tooltipContainer: env && env.getModalContainer ? env.getModalContainer : undefined, disabled: disabled, onClick: _this.copyItem.bind(_this, rowIndex + offset, undefined) },
        ...
        if (props.needConfirm === false) {
            columns = columns.map(function (column) {
                ...
                return quickEdit === false
                    ...
                    : tslib.__assign(tslib.__assign({}, column), { quickEdit: tslib.__assign(tslib.__assign(tslib.__assign({}, _this.columnToQuickEdit(column)), quickEdit), { saveImmediately: true, mode: 'inline', disabled: disabled, static: isStatic }) });
            });
        }
            ...
            columns = columns.map(function (column) {
                ...
                return quickEdit === false
                    ? omit__default["default"](column, ['quickEdit'])
                    : tslib.__assign(tslib.__assign({}, column), { quickEdit: tslib.__assign(tslib.__assign(tslib.__assign({}, _this.columnToQuickEdit(column)), quickEdit), { isQuickEditFormMode: !!(render === null || render === void 0 ? void 0 : render.isFormItem), saveImmediately: true, mode: 'inline', disabled: disabled }) });
            });
                ...
                btns.push({
                    children: function (_a) {
                        ...
                        return ~_this.state.editIndex || (data && data.__isPlaceholder) ? null : (React__default["default"].createElement(amisUi.Button, { classPrefix: ns, size: "sm", key: key, level: "link", tooltip: __('Table.editRow'), tooltipContainer: env && env.getModalContainer
                                ...
                                : undefined, disabled: disabled, onClick: function () { return _this.startEdit(rowIndex + offset); } },
            ...
            !isStatic && btns.push({
                children: function (_a) {
                    ...
                    return _this.state.editIndex === rowIndex + offset ? (React__default["default"].createElement(amisUi.Button, { classPrefix: ns, size: "sm", key: key, level: "link", tooltip: __('save'), tooltipContainer: env && env.getModalContainer ? env.getModalContainer : undefined, onClick: _this.confirmEdit },
                        props.confirmBtnIcon ? (typeof props.confirmBtnIcon === 'string' ? (React__default["default"].createElement(amisUi.Icon, { icon: props.confirmBtnIcon, className: "icon" })) : (amisCore.generateIcon(props.classnames, props.confirmBtnIcon))) : null,
                        props.confirmBtnLabel ? (React__default["default"].createElement("span", null, props.confirmBtnLabel)) : null)) : null;
                }
            });
            !isStatic && btns.push({
                children: function (_a) {
                    ...
                    return _this.state.editIndex === rowIndex + offset ? (React__default["default"].createElement(amisUi.Button, { classPrefix: ns, size: "sm", key: key, level: "link", tooltip: __('cancel'), tooltipContainer: env && env.getModalContainer ? env.getModalContainer : undefined, onClick: _this.cancelEdit },
                        props.cancelBtnIcon ? (typeof props.cancelBtnIcon === 'string' ? (React__default["default"].createElement(amisUi.Icon, { icon: props.cancelBtnIcon, className: "icon" })) : (amisCore.generateIcon(props.classnames, props.cancelBtnIcon))) : null,
                        props.cancelBtnLabel ? (React__default["default"].createElement("span", null, props.cancelBtnLabel)) : null)) : null;
                }
            });
        }
        else {
            ...
            btns.push({
                children: function (_a) {
                    ...
                    return ((~_this.state.editIndex || (data && data.__isPlaceholder)) &&
                        needConfirm !== false) ||
                        minLength >= _this.state.items.length ? null : (React__default["default"].createElement(amisUi.Button, { classPrefix: ns, size: "sm", key: key, level: "link", tooltip: __('Table.deleteRow'), tooltipContainer: env && env.getModalContainer ? env.getModalContainer : undefined, disabled: disabled, onClick: _this.removeItem.bind(_this, rowIndex + offset) },
    ...
    FormTable.prototype.handleTableSave = function (rows, diff, rowIndexes) {
        ...
        if (Array.isArray(rows)) {
            ...
            var comboNames_1 = [];
            ((_a = this.props.$schema.columns) !== null && _a !== void 0 ? _a : []).forEach(function (e) {
    ...
    FormTable.prototype.render = function () {
        var _this = this;
        var _a, _b;
        var _c = this.props, className = _c.className; _c.style; _c.value; var disabled = _c.disabled, render = _c.render, placeholder = _c.placeholder, draggable = _c.draggable, addable = _c.addable, columnsTogglable = _c.columnsTogglable, combineNum = _c.combineNum, combineFromIndex = _c.combineFromIndex, __ = _c.translate, canAccessSuperData = _c.canAccessSuperData, expandConfig = _c.expandConfig, affixRow = _c.affixRow, prefixRow = _c.prefixRow, formInited = _c.formInited, perPage = _c.perPage, cx = _c.classnames, rowClassName = _c.rowClassName, rowClassNameExpr = _c.rowClassNameExpr, _d = _c.affixHeader, affixHeader = _d === void 0 ? false : _d, _e = _c.autoFillHeight, autoFillHeight = _e === void 0 ? false : _e, tableContentClassName = _c.tableContentClassName, isStatic = _c.static, showFooterAddBtn = _c.showFooterAddBtn; _c.showTableAddBtn; var footerAddBtn = _c.footerAddBtn;
        var maxLength = this.resolveVariableProps(this.props, 'maxLength');
        if (formInited === false) {
            return null;
        }
        ...
        var footerAddBtnDisabled = this.computedAddBtnDisabled();
        var footerAddBtnSchema = tslib.__assign({ type: 'button', level: 'primary', size: 'sm', label: __('Table.add'), icon: 'fa fa-plus', disabled: footerAddBtnDisabled }, (footerAddBtnDisabled ? { disabledTip: __('Table.addButtonDisabledTip') } : {}));
        ...
        return (React__default["default"].createElement("div", { className: cx('InputTable', className) },
            ...
            (!isStatic && addable &&
                ...
                addable && showFooterAddBtn !== false ? (render('button', footerAddBtnSchema, {
