...
var DateControl = /** @class */ (function (_super) {
    ...
    DateControl.prototype.render = function () {
        var _a = this.props, className = _a.className; _a.style; _a.defaultValue; _a.defaultData; var cx = _a.classnames; _a.minDate; _a.maxDate; var type = _a.type, format = _a.format, timeFormat = _a.timeFormat, valueFormat = _a.valueFormat, env = _a.env, largeMode = _a.largeMode; _a.render; var useMobileUI = _a.useMobileUI, placeholder = _a.placeholder, rest = tslib.__rest(_a, ["className", "style", "defaultValue", "defaultData", "classnames", "minDate", "maxDate", "type", "format", "timeFormat", "valueFormat", "env", "largeMode", "render", "useMobileUI", "placeholder"]);
        ...
        return (React__default["default"].createElement("div", { className: cx("DateControl", {
            ...
            React__default["default"].createElement(amisUi.DatePicker, tslib.__assign({}, rest, { placeholder: placeholder !== null && placeholder !== void 0 ? placeholder : this.placeholder, useMobileUI: useMobileUI, popOverContainer: mobileUI && env && env.getModalContainer
...
var DateControlRenderer = /** @class */ (function (_super) {
    ...
    DateControlRenderer.defaultProps = tslib.__assign(tslib.__assign({}, DateControl.defaultProps), { dateFormat: 'YYYY-MM-DD', timeFormat: '', strictMode: false });
...
/** @class */ ((function (_super) {
    ...
    DatetimeControlRenderer.defaultProps = tslib.__assign(tslib.__assign({}, DateControl.defaultProps), { inputFormat: 'YYYY-MM-DD HH:mm:ss', dateFormat: 'LL', timeFormat: 'HH:mm:ss', closeOnSelect: false, strictMode: false });
...
/** @class */ ((function (_super) {
    ...
    TimeControlRenderer.defaultProps = tslib.__assign(tslib.__assign({}, DateControl.defaultProps), { inputFormat: 'HH:mm', dateFormat: '', timeFormat: 'HH:mm', viewMode: 'time', closeOnSelect: false });
...
/** @class */ ((function (_super) {
    ...
    MonthControlRenderer.defaultProps = tslib.__assign(tslib.__assign({}, DateControl.defaultProps), { inputFormat: 'YYYY-MM', dateFormat: 'MM', timeFormat: '', viewMode: 'months', closeOnSelect: true, strictMode: false });
...
/** @class */ ((function (_super) {
    ...
    QuarterControlRenderer.defaultProps = tslib.__assign(tslib.__assign({}, DateControl.defaultProps), { inputFormat: 'YYYY [Q]Q', dateFormat: 'YYYY [Q]Q', timeFormat: '', viewMode: 'quarters', closeOnSelect: true, strictMode: false });
...
/** @class */ ((function (_super) {
    ...
    YearControlRenderer.defaultProps = tslib.__assign(tslib.__assign({}, DateControl.defaultProps), { inputFormat: 'YYYY', dateFormat: 'YYYY', timeFormat: '', viewMode: 'years', closeOnSelect: true, strictMode: false });
