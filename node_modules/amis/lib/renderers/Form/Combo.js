...
var ComboControl = /** @class */ (function (_super) {
    ...
    ComboControl.prototype.renderItems = function (finnalControls, data, index) {
        var _a = this.props, cx = _a.classnames, formClassName = _a.formClassName, render = _a.render, multiLine = _a.multiLine, disabled = _a.disabled, canAccessSuperData = _a.canAccessSuperData, multiple = _a.multiple, tabsMode = _a.tabsMode, subFormMode = _a.subFormMode, changeImmediately = _a.changeImmediately, lazyLoad = _a.lazyLoad; _a.translate; var isStatic = _a.static;
        // 单个
        if (!multiple) {
    ...
    ComboControlRenderer.prototype.setData = function (value, replace, index) {
        ...
        if (multiple) {
            if (index !== undefined && ~index) {
                var newValue = tslib.__spreadArray([], tslib.__read(this.getValueAsArray()), false);
