...
var Carousel = /** @class */ (function (_super) {
    ...
    Carousel.prototype.render = function () {
        var _a;
        var _this = this;
        var _b = this.props, render = _b.render, className = _b.className, style = _b.style, cx = _b.classnames, itemSchema = _b.itemSchema, animation = _b.animation, width = _b.width, height = _b.height, controls = _b.controls, controlsTheme = _b.controlsTheme, placeholder = _b.placeholder, data = _b.data, name = _b.name, duration = _b.duration, multiple = _b.multiple, alwaysShowArrow = _b.alwaysShowArrow, icons = _b.icons;
        ...
        if (Array.isArray(options) && options.length) {
            ...
            var transitionDuration_1 = multipleCount_1 > 1 && typeof duration === 'number'
                ? "".concat(duration, "ms") : (duration || '500ms');
            var timeout_1 = multipleCount_1 > 1 && typeof duration === 'number' ? duration : 500;
            body = (React__default["default"].createElement("div", { ref: this.wrapperRef, className: cx('Carousel-container'), onMouseEnter: this.handleMouseEnter, onMouseLeave: this.handleMouseLeave }, options.map(function (option, key) { return (React__default["default"].createElement(Transition__default["default"], { mountOnEnter: true, unmountOnExit: true, in: key === current, timeout: timeout_1, key: key }, function (status) {
                var _a;
                ...
                var transformStyles = (_a = {},
                    ...
                    _a[Transition.EXITING] = animationName === 'slideRight' ? 100 / multipleCount_1 : -100 / multipleCount_1,
                    _a[Transition.EXITED] = animationName === 'slideRight' ? -100 / multipleCount_1 : 100 / multipleCount_1,
                    _a);
                var itemStyle = multipleCount_1 > 1 ? tslib.__assign({ transitionTimingFunction: 'linear', transitionDuration: transitionDuration_1 }, (animation === 'slide' ? { transform: "translateX(".concat(transformStyles[status], "%)") } : {})) : {};
                ...
                return (React__default["default"].createElement("div", { className: cx('Carousel-item', animationName, animationStyles[status]), style: itemStyle },
                    multipleCount_1 === 1 ? itemRender(option) : null,
                    multipleCount_1 > 1 ?
                        newOptions_1[key].map(function (option, index) { return (React__default["default"].createElement("div", { key: index, style: {
                                width: 100 / multipleCount_1 + '%',
                                height: '100%',
                                float: 'left'
                            } }, itemRender(option))); }) : null));
            })); })));
        }
        return (React__default["default"].createElement("div", { className: cx("Carousel Carousel--".concat(controlsTheme), (_a = {}, _a['Carousel-arrow--always'] = !!alwaysShowArrow, _a), className), style: carouselStyles },
            body ? body : placeholder,
            dots ? this.renderDots() : null,
            arrows ? (React__default["default"].createElement("div", { className: cx('Carousel-leftArrow'), onClick: this.prev }, icons && icons.prev
                ? React__default["default"].isValidElement(icons.prev) ? icons.prev : render('arrow-prev', icons.prev)
                : (React__default["default"].createElement(amisUi.Icon, { icon: "left-arrow", className: "icon" })))) : null,
            arrows ? (React__default["default"].createElement("div", { className: cx('Carousel-rightArrow'), onClick: this.next }, icons && icons.next
                ? React__default["default"].isValidElement(icons.next) ? icons.next : render('arrow-next', icons.next)
