    ...
    ListItem.prototype.renderLeft = function () {
        ...
        if (dragging) {
            ...
            return (React__default["default"].createElement("div", { className: cx('ListItem-checkBtn') },
                React__default["default"].createElement(amisUi.Checkbox, { classPrefix: ns, type: multiple !== false ? 'checkbox' : 'radio', disabled: !checkable, checked: selected, onChange: checkOnItemClick ? amisCore.noop : this.handleCheck, inline: true })));
        }
        return null;
    };
