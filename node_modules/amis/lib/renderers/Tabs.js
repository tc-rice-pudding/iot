...
var Tabs = /** @class */ (function (_super) {
    ...
    Tabs.prototype.initTabArray = function (tabs, source, data) {
        ...
        arr.forEach(function (value, index) {
            ...
            sourceTabs.push.apply(sourceTabs, tslib.__spreadArray([], tslib.__read(tabs.map(function (tab) { return (tslib.__assign(tslib.__assign({}, tab), { ctx: ctx })); })), false));
        });
    ...
    Tabs.prototype.renderTabs = function () {
        ...
        if (isFromSource) {
            children = tabs.map(function (tab, index) {
                return amisCore.isVisible(tab, tab.ctx) ? (React__default["default"].createElement(amisUi.Tab, tslib.__assign({}, tab, { title: amisCore.filter(tab.title, tab.ctx), disabled: disabled || amisCore.isDisabled(tab, tab.ctx), key: index, eventKey: index, mountOnEnter: mountOnEnter, unmountOnExit: typeof tab.reload === 'boolean'
                        ? tab.reload
            ...
            children = tabs.map(function (tab, index) {
                return amisCore.isVisible(tab, data) ? (React__default["default"].createElement(amisUi.Tab, tslib.__assign({}, tab, { title: amisCore.filter(tab.title, data), disabled: disabled || amisCore.isDisabled(tab, data), key: index, eventKey: tab.hash || index, mountOnEnter: mountOnEnter, unmountOnExit: typeof tab.reload === 'boolean'
                        ? tab.reload
                        : typeof tab.unmountOnExit === 'boolean'
                            ? tab.unmountOnExit
