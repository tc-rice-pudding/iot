...
import { __extends, __read, __assign, __spreadArray, __awaiter, __generator, __decorate, __metadata } from 'tslib';
import React from 'react';
import { resolveVariableAndFilter, createObject, isObject, getVariable, isObjectShallowModified, isVisible, resolveEventData, filter, isDisabled, autobind, ScopedContext, Renderer, str2AsyncFunction } from 'amis-core';
...
var Tabs = /** @class */ (function (_super) {
    ...
    Tabs.prototype.initTabArray = function (tabs, source, data) {
        ...
        arr.forEach(function (value, index) {
            ...
            sourceTabs.push.apply(sourceTabs, __spreadArray([], __read(tabs.map(function (tab) { return (__assign(__assign({}, tab), { ctx: ctx })); })), false));
        });
    ...
    Tabs.prototype.renderTabs = function () {
        ...
        if (isFromSource) {
            children = tabs.map(function (tab, index) {
                return isVisible(tab, tab.ctx) ? (React.createElement(Tab, __assign({}, tab, { title: filter(tab.title, tab.ctx), disabled: disabled || isDisabled(tab, tab.ctx), key: index, eventKey: index, mountOnEnter: mountOnEnter, unmountOnExit: typeof tab.reload === 'boolean'
                        ? tab.reload
            ...
            children = tabs.map(function (tab, index) {
                return isVisible(tab, data) ? (React.createElement(Tab, __assign({}, tab, { title: filter(tab.title, data), disabled: disabled || isDisabled(tab, data), key: index, eventKey: tab.hash || index, mountOnEnter: mountOnEnter, unmountOnExit: typeof tab.reload === 'boolean'
                        ? tab.reload
                        : typeof tab.unmountOnExit === 'boolean'
                            ? tab.unmountOnExit
