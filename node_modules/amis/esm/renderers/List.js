    ...
    ListItem.prototype.renderLeft = function () {
        ...
        if (dragging) {
            ...
            return (React.createElement("div", { className: cx('ListItem-checkBtn') },
                React.createElement(Checkbox, { classPrefix: ns, type: multiple !== false ? 'checkbox' : 'radio', disabled: !checkable, checked: selected, onChange: checkOnItemClick ? noop : this.handleCheck, inline: true })));
        }
        return null;
    };
