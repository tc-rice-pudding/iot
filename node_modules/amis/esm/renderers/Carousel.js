...
import { getPropValue, isArrayChildrenModified, resolveVariableAndFilter, createObject, autobind, ScopedContext, Renderer, isObject } from 'amis-core';
...
var Carousel = /** @class */ (function (_super) {
    ...
    Carousel.prototype.render = function () {
        ...
        if (Array.isArray(options) && options.length) {
            ...
            body = (React.createElement("div", { ref: this.wrapperRef, className: cx('Carousel-container'), onMouseEnter: this.handleMouseEnter, onMouseLeave: this.handleMouseLeave }, options.map(function (option, key) { return (React.createElement(Transition, { mountOnEnter: true, unmountOnExit: true, in: key === current, timeout: timeout_1, key: key }, function (status) {
                ...
                if (multipleCount_1 > 1) {
                    if ((status === ENTERING || status === EXITING) && !_this.loading) {
                        _this.loading = true;
                    }
                    else if ((status === ENTERED || status === EXITED) && _this.loading) {
                        _this.loading = false;
                    }
                }
                var transformStyles = (_a = {},
                    _a[ENTERING] = 0,
                    _a[ENTERED] = 0,
                    _a[EXITING] = animationName === 'slideRight' ? 100 / multipleCount_1 : -100 / multipleCount_1,
                    _a[EXITED] = animationName === 'slideRight' ? -100 / multipleCount_1 : 100 / multipleCount_1,
                    _a);
                var itemStyle = multipleCount_1 > 1 ? __assign({ transitionTimingFunction: 'linear', transitionDuration: transitionDuration_1 }, (animation === 'slide' ? { transform: "translateX(".concat(transformStyles[status], "%)") } : {})) : {};
        ...
        return (React.createElement("div", { className: cx("Carousel Carousel--".concat(controlsTheme), (_a = {}, _a['Carousel-arrow--always'] = !!alwaysShowArrow, _a), className), style: carouselStyles },
            body ? body : placeholder,
            dots ? this.renderDots() : null,
            arrows ? (React.createElement("div", { className: cx('Carousel-leftArrow'), onClick: this.prev }, icons && icons.prev
                ? React.isValidElement(icons.prev) ? icons.prev : render('arrow-prev', icons.prev)
                : (React.createElement(Icon, { icon: "left-arrow", className: "icon" })))) : null,
            arrows ? (React.createElement("div", { className: cx('Carousel-rightArrow'), onClick: this.next }, icons && icons.next
                ? React.isValidElement(icons.next) ? icons.next : render('arrow-next', icons.next)
                : (React.createElement(Icon, { icon: "right-arrow", className: "icon" })))) : null));
    };
