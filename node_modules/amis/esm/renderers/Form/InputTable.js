...
import { __extends, __assign, __awaiter, __generator, __decorate, __metadata, __spreadArray, __read } from 'tslib';
import React from 'react';
import { SimpleMap, isPureVariable, resolveVariableAndFilter, getVariable, dataMapping, isEffectiveApi, filterDate, setVariable, isExpression, createObject, filter, getRendererByName, generateIcon, getTree, spliceTree, autobind, FormItem } from 'amis-core';
...
var FormTable = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        remote = null;
                        apiMsg = undefined;
                        if (!(isNew && isEffectiveApi(addApi, createObject(data, item)))) return [3 /*break*/, 3];
                    ...
                    case 2:
                        ...
                        return [3 /*break*/, 5];
                    case 3:
                        if (!isEffectiveApi(updateApi, createObject(data, item))) return [3 /*break*/, 5];
    ...
    FormTable.prototype.buildColumns = function (props, isCreateMode) {
            ...
            btns.push({
                children: function (_a) {
                    ...
                    return (~_this.state.editIndex && needConfirm !== false) ||
                        maxLength <= _this.state.items.length ? null : (React.createElement(Button, { classPrefix: ns, size: "sm", key: key, level: "link", tooltip: __('Table.addRow'), tooltipContainer: env && env.getModalContainer ? env.getModalContainer : undefined, disabled: disabled, onClick: _this.addItem.bind(_this, rowIndex + offset, undefined) },
        ...
        if (!isStatic && props.copyable && props.showCopyBtn !== false) {
            btns.push({
                children: function (_a) {
                    var key = _a.key, rowIndex = _a.rowIndex, offset = _a.offset;
                    return ~_this.state.editIndex && needConfirm !== false ? null : (React.createElement(Button, { classPrefix: ns, size: "sm", key: key, level: "link", tooltip: __('Table.copyRow'), tooltipContainer: env && env.getModalContainer ? env.getModalContainer : undefined, disabled: disabled, onClick: _this.copyItem.bind(_this, rowIndex + offset, undefined) },
        ...
        if (props.needConfirm === false) {
            columns = columns.map(function (column) {
                ...
                return quickEdit === false
                    ...
                    : __assign(__assign({}, column), { quickEdit: __assign(__assign(__assign({}, _this.columnToQuickEdit(column)), quickEdit), { saveImmediately: true, mode: 'inline', disabled: disabled, static: isStatic }) });
            });
        }
            ...
            columns = columns.map(function (column) {
                ...
                return quickEdit === false
                    ? omit(column, ['quickEdit'])
                    : __assign(__assign({}, column), { quickEdit: __assign(__assign(__assign({}, _this.columnToQuickEdit(column)), quickEdit), { isQuickEditFormMode: !!(render === null || render === void 0 ? void 0 : render.isFormItem), saveImmediately: true, mode: 'inline', disabled: disabled }) });
            });
            ...
            !isStatic && btns.push({
                children: function (_a) {
                    ...
                    return _this.state.editIndex === rowIndex + offset ? (React.createElement(Button, { classPrefix: ns, size: "sm", key: key, level: "link", tooltip: __('save'), tooltipContainer: env && env.getModalContainer ? env.getModalContainer : undefined, onClick: _this.confirmEdit },
                        props.confirmBtnIcon ? (typeof props.confirmBtnIcon === 'string' ? (React.createElement(Icon, { icon: props.confirmBtnIcon, className: "icon" })) : (generateIcon(props.classnames, props.confirmBtnIcon))) : null,
            ...
            !isStatic && btns.push({
                children: function (_a) {
                    ...
                    return _this.state.editIndex === rowIndex + offset ? (React.createElement(Button, { classPrefix: ns, size: "sm", key: key, level: "link", tooltip: __('cancel'), tooltipContainer: env && env.getModalContainer ? env.getModalContainer : undefined, onClick: _this.cancelEdit },
                        props.cancelBtnIcon ? (typeof props.cancelBtnIcon === 'string' ? (React.createElement(Icon, { icon: props.cancelBtnIcon, className: "icon" })) : (generateIcon(props.classnames, props.cancelBtnIcon))) : null,
            ...
            btns.push({
                children: function (_a) {
                    ...
                    return ((~_this.state.editIndex || (data && data.__isPlaceholder)) &&
                        needConfirm !== false) ||
                        minLength >= _this.state.items.length ? null : (React.createElement(Button, { classPrefix: ns, size: "sm", key: key, level: "link", tooltip: __('Table.deleteRow'), tooltipContainer: env && env.getModalContainer ? env.getModalContainer : undefined, disabled: disabled, onClick: _this.removeItem.bind(_this, rowIndex + offset) },
    ...
    FormTable.prototype.render = function () {
        ...
        var footerAddBtnSchema = __assign({ type: 'button', level: 'primary', size: 'sm', label: __('Table.add'), icon: 'fa fa-plus', disabled: footerAddBtnDisabled }, (footerAddBtnDisabled ? { disabledTip: __('Table.addButtonDisabledTip') } : {}));
