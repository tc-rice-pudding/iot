                ...
                isDragActive || isDragAccept || isDragReject ? (React.createElement("div", { className: cx('ImageControl-acceptTip', {
                    ...
                    (multiple && (!maxLength || files.length < maxLength)) ||
                        (!multiple && !files.length) ? (React.createElement("label", { className: cx('ImageControl-addBtn', {
                            'is-disabled': disabled
                        }, fixedSize ? 'ImageControl-fixed-size' : '', fixedSize ? fixedSizeClassName : ''), style: frameImageStyle, onClick: _this_1.handleSelect, "data-tooltip": __(placeholder), "data-position": placeholderPlacement, ref: _this_1.frameImageRef },
