...
var JSONSchemaEditorControl = /** @class */ (function (_super) {
    ...
    JSONSchemaEditorControl.prototype.render = function () {
        ...
        return (React.createElement(JSONSchemaEditor, __assign({}, rest, { placeholder: this.normalizePlaceholder(), enableAdvancedSetting: enableAdvancedSetting, renderModalProps: this.renderModalProps })));
    };
