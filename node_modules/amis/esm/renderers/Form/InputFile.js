        ...
        return (React.createElement("div", { className: cx('FileControl', className) },
            ...
            Array.isArray(files) ? (React.createElement("ul", { className: cx('FileControl-list') }, files.map(function (file, index) {
                ...
                return (React.createElement("li", { key: file.id },
                    React.createElement(TooltipWrapper, { placement: "bottom", container: container || (env === null || env === void 0 ? void 0 : env.getModalContainer), tooltipClassName: cx('FileControl-list-tooltip'), tooltip: file.state === 'invalid' || file.state === 'error'
                            ? file.error ||
