...
var NumberControl = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, dispatchEvent('change', resolveEventData(this.props, { value: resultValue }, 'value'))];
                    case 1:
    ...
    NumberControl.prototype.render = function () {
        ...
        return (React.createElement("div", { className: cx("".concat(ns, "NumberControl"), (_a = {},
            ...
            unitOptions ? (unitOptions.length > 1 ? (React.createElement(Select, { value: unit, clearable: false, options: this.state.unitOptions || [], onChange: this.handleChangeUnit, className: "".concat(ns, "NumberControl-unit") })) : (React.createElement("div", { className: cx("".concat(ns, "NumberControl-unit"), " ".concat(ns, "NumberControl-single-unit"), "".concat(ns, "Select")) }, typeof unitOptions[0] === 'string'
                ? unitOptions[0]
