...
import { isPureVariable, resolveVariableAndFilter, getPropValue, filter, generateIcon, Renderer } from 'amis-core';
...
var StatusField = /** @class */ (function (_super) {
    ...
    StatusField.prototype.render = function () {
        ...
        if (status.icon) {
            ...
            if (svgIcon_1) {
                iconElement = (React.createElement(Icon, { icon: svgIcon_1, className: cx('Status-icon icon', itemClassName), key: "icon" }));
            }
            else {
        ...
        return (React.createElement("span", { className: cx('StatusField', wrapClassName, className, status.className), style: __assign(__assign({}, style), (status.color ? { color: filter(status.color, data) } : {})) },
            iconElement,
            labelElement));
    };
