...
var Service = /** @class */ (function (_super) {
    ...
    Service.prototype.render = function () {
        ...
        return (React.createElement("div", { className: cx("".concat(ns, "Service"), className), style: style },
            store.error && showErrorMsg !== false ? (React.createElement(Alert2, { level: "danger", showCloseButton: true, onClose: function () { return store.updateMessage(''); } }, store.msg)) : null,
            this.renderBody(),
