...
import { getPropValue, stripNumber, Renderer } from 'amis-core';
...
var NumberField = /** @class */ (function (_super) {
    ...
    NumberField.prototype.render = function () {
        var _a = this.props, placeholder = _a.placeholder, kilobitSeparator = _a.kilobitSeparator, precision = _a.precision, prefix = _a.prefix, affix = _a.affix, percent = _a.percent, className = _a.className, style = _a.style, cx = _a.classnames, __ = _a.translate;
