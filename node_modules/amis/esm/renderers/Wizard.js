...
import { isEffectiveApi, until, toNumber, tokenize, getScrollParent, resizeSensor, isApiOutdated, createObject, filter, isVisible, autobind, evalExpression, ScopedContext, Renderer, ServiceStore, SkipOperation } from 'amis-core';
                                    ...
                                    switch (_a.label) {
                                        ...
                                        case 2:
                                            ...
                                            if (finalRedirect) {
                                                ...
                                                this.reloadTarget(filter(action.reload || step.reload || reload, store.data), store.data);
                                            }
                                            return [2 /*return*/, value];
                                    }
                                });
