...
function convertNumToFormat(numFmt, num) {
    switch (numFmt) {
        case Types.ST_NumberFormat.decimal:
            return num.toString();
        case Types.ST_NumberFormat.lowerLetter:
            return String.fromCharCode(96 + num);
        case Types.ST_NumberFormat.upperLetter:
            return String.fromCharCode(64 + num);
        case Types.ST_NumberFormat.lowerRoman:
            return romanize(num).toLowerCase();
        case Types.ST_NumberFormat.upperRoman:
            return romanize(num).toUpperCase();
        case Types.ST_NumberFormat.bullet:
            // 原本其实是用
            return '&bull;';
        default:
            return num.toString();
...
function renderNumbering(p, word, numPr) {
    ...
    if (num.lvlOverride) {
        lvls = tslib_es6.__assign(tslib_es6.__assign({}, lvls), num.lvlOverride.lvls);
    }
    ...
    if (lvl.numFmt !== Types.ST_NumberFormat.bullet ||
