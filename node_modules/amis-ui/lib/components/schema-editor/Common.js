                    ...
                    return isOpened ? (React__default["default"].createElement(Form["default"], { defaultValue: value, onSubmit: onChange, ref: ref }, function (_a) {
                        ...
                        return (React__default["default"].createElement(React__default["default"].Fragment, null,
                            React__default["default"].createElement(FormField.Controller, { label: __('JSONSchema.title'), name: "title", control: control, rules: { maxLength: 20 }, isRequired: true, render: function (_a) {
                                    var _b;
                                    var field = _a.field;
                                    return (React__default["default"].createElement(InputBox["default"], tslib.__assign({}, field, { disabled: disabled, placeholder: __((_b = placeholder === null || placeholder === void 0 ? void 0 : placeholder.title) !== null && _b !== void 0 ? _b : '') })));
                                } }),
                            React__default["default"].createElement(FormField.Controller, { label: __('JSONSchema.description'), name: "description", control: control, render: function (_a) {
                                    var _b;
                                    var field = _a.field;
                                    return (React__default["default"].createElement(Textarea["default"], tslib.__assign({}, field, { disabled: disabled, placeholder: __((_b = placeholder === null || placeholder === void 0 ? void 0 : placeholder.description) !== null && _b !== void 0 ? _b : '') })));
                                } }),
                            React__default["default"].createElement(FormField.Controller, { label: __('JSONSchema.default'), name: "default", control: control, render: function (_a) {
                                    var _b;
                                    var field = _a.field;
                                    return (React__default["default"].createElement(InputBox["default"], tslib.__assign({}, field, { disabled: disabled, placeholder: __((_b = placeholder === null || placeholder === void 0 ? void 0 : placeholder.default) !== null && _b !== void 0 ? _b : '') })));
