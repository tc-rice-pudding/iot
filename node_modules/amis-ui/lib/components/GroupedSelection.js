...
var GroupedSelection = /** @class */ (function (_super) {
    ...
    GroupedSelection.prototype.renderCheckAll = function () {
        ...
        return (React__default["default"].createElement("div", { className: cx('GroupedSelection-item', itemClassName), onClick: this.toggleAll },
            ...
            React__default["default"].createElement("div", { className: cx('GroupedSelection-itemLabel') }, __(checkAllLabel))));
    };
        ...
        if (Array.isArray(options) && options.length) {
            ...
            body =
                flattendOptions_1.length > virtualThreshold ? (React__default["default"].createElement(AutoSizer["default"], { minHeight: virtualListHeight }, function (_a) {
                    ...
                    return (React__default["default"].createElement(index["default"], { height: height, itemCount: flattendOptions_1.length, itemSize: itemHeight, prefix: _this.renderCheckAll(), renderItem: function (_a) {
