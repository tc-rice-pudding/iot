...
var Select = /** @class */ (function (_super) {
    ...
    Select.prototype.renderOuter = function (_a) {
        ...
        return mobileUI ? (React__default["default"].createElement(PopUp["default"], { className: cx("Select-popup"), container: popOverContainer, isShow: this.state.isOpen, onHide: this.close }, menu)) : (React__default["default"].createElement(amisCore.Overlay, { container: popOverContainer || this.getTarget, containerSelector: popOverContainerSelector, target: this.getTarget, placement: overlayPlacement === 'auto'
