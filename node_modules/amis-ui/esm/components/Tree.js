...
import { eachTree, getTreeAncestors, getTreeParent, findTreeIndex, isVisible, highlight, hasAbility, flattenTree, autobind, themeable, localeable } from 'amis-core';
...
var TreeSelector = /** @class */ (function (_super) {
    ...
    TreeSelector.prototype.renderItem = function (_a) {
        ...
        return (React__default.createElement("li", { key: item[valueField], className: cx("Tree-item ".concat(itemClassName || ''), {
